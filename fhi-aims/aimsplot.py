...
# original path for script /usr/bin/env python
#
...
print(PLOT_BANDS, PLOT_DOS, PLOT_DOS_TETRAHEDRON, PLOT_DOS_SPECIES, PLOT_DOS_SPECIES_TETRAHEDRON)
#######################
